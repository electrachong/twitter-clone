                ...
                <div class="center-children"><h2><button id="create_button">Create a post</button></h2></div>
                    ...
                    <form id="postForm">
                        ...
                        <label for="postarea"> Write a post:
                            <textarea id="postarea">Write a post</textarea>
                        </label>
                        <br>
                    ...
                    <noscript>
                        <form>
                            ...
                            <input id="location_noscript" type="checkbox" name="location" value="include_location"> Include a location
                            <br>
                            <label for="postarea_noscript"> Write a post:
                                <textarea id="postarea_noscript">Write a post</textarea>
                            </label>
                            <br>
                            <input type="submit" value="Post">
                        </form>
                    ...
                    <div class="post">
                        ...
                        <form class="replyForm" id="post1">
                            ...
                            <input id="location1" type="checkbox" name="location" value="include_location">
                            <br>
                            <label for="postarea1"> Write a post: </label>
                            <textarea id="postarea1">Write a post</textarea>
                            <br>
                            <input type="submit" value="Post">
                        </form>
                    ...
                    <div class="post">
                        ...
                        <form class="replyForm" id="post2">
                            ...
                            <input id="location2" type="checkbox" name="location" value="include_location">
                            <br>
                            <label for="postarea2"> Write a post: </label>
                            <textarea id="postarea2">Write a post</textarea>
                            <br>
                            <input type="submit" value="Post">
                        </form>
                    </div>
                    ...
                    <div class="post">
                        ...
                        <form class="replyForm" id="post3">
                            ...
                            <input id="location3" type="checkbox" name="location" value="include_location">
                            <br>
                            <label for="postarea3"> Write a post: </label>
                            <textarea id="postarea3">Write a post</textarea>
                            <br>
                            <input type="submit" value="Post">
                        </form>
                    </div>
                    ...
                    <div class="post">
                        ...
                        <p class="username"><a href="#">Ian</a></p>
                        ...
                        <form class="replyForm" id="post4">
                            ...
                            <input id="location4" type="checkbox" name="location" value="include_location">
                            <br>
                            <label for="postarea4"> Write a post: </label>
                            <textarea id="postarea4">Write a post</textarea>
                            <br>
                            <input type="submit" value="Post">
                        </form>
                    </div>
                    ...
                    <div class="post">
                        ...
                        <form class="replyForm" id="post5">
                            ...
                            <input id="location5" type="checkbox" name="location" value="include_location">
                            <br>
                            <label for="postarea5"> Write a post: </label>
                            <textarea id="postarea5">Write a post</textarea>
                            <br>
                            <input type="submit" value="Post">
                        </form>
                    </div>
                    ...
                    <div class="post">
                        ...
                        <p class="username"><a href="#">Rick</a></p>
                        <br>
                        <p class="date">Feb 2, 2016</p>
                        ...
                        <form class="replyForm" id="post6">
                            ...
                            <input id="location6" type="checkbox" name="location" value="include_location">
                            <br>
                            <label for="postarea6"> Write a post: </label>
                            <textarea id="postarea6">Write a post</textarea>
                            <br>
                            <input type="submit" value="Post">
                        </form>
                    </div>
                    ...
                    <div class="post">
                        ...
                        <p class="username"><a href="#">Bennett</a></p>
                        <br>
                        <p class="date">Feb 2, 2016</p>
                        ...
                        <form class="replyForm" id="post7">
                            ...
                            <input id="location7" type="checkbox" name="location" value="include_location">
                            <br>
                            <label for="postarea7"> Write a post: </label>
                            <textarea id="postarea7">Write a post</textarea>
                            <br>
                            <input type="submit" value="Post">
                        </form>
                    </div>
                    ...
                    <div class="post">
                        ...
                        <form class="replyForm" id="post8">
                            ...
                            <input id="location8" type="checkbox" name="location" value="include_location">
                            <br>
                            <label for="postarea8"> Write a post: </label>
                            <textarea id="postarea8">Write a post</textarea>
                            <br>
                            <input type="submit" value="Post">
                        </form>
                    </div>
                    ...
                    <div class="post">
                        ...
                        <form class="replyForm" id="post9">
                            ...
                            <input id="location9" type="checkbox" name="location" value="include_location">
                            <br>
                            <label for="postarea9"> Write a post: </label>
                            <textarea id="postarea9">Write a post</textarea>
                            <br>
                            <input type="submit" value="Post">
                        </form>
                    </div>
                    ...
                    <div class="post">
                        ...
                        <form class="replyForm" id="post10">
                            ...
                            <input id="location10" type="checkbox" name="location" value="include_location">
                            <br>
                            <label for="postarea10"> Write a post: </label>
                            <textarea id="postarea10">Write a post</textarea>
                            <br>
                            <input type="submit" value="Post">
                        </form>
                    </div>
